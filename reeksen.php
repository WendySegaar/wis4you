...
<body>
	...
	<div class="container">
		...
		<button class="buttonR" id="pittigReken_knopA" onclick="bereken(5);">Fibonacci reeks</button>
		<button class="buttonR" id="pittigReken_knopB" onclick="bereken(6);">Priemgetallen</button>
