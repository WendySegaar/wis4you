...
<body>
	...
	<div id="rekenen_container" class="container">
		<div id="berekening">Maak een keuze welke berekening je uit wilt voeren</div>
		<button class="buttonR" id="reken_knopA" onclick="bereken(1);">Tafelreeks</button>
		<button class="buttonR" id="reken_knopB" onclick="bereken(2);">Machtreeks</button>
		<button class="buttonR" id="reken_knopC" onclick="bereken(3);">Breukenreeks</button>
		<button class="buttonR" id="reken_knopD" onclick="bereken(4);">Kwadratenreeks</button>
